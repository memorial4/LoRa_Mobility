...
void TractorMobility::setTargetPosition()
{
    ...
    nextChange = simTime() + positionDelta.length() / speed->doubleValue();
}

// I added this
double TractorMobility::getMaxSpeed() const
{
    return speed->isExpression() ? NaN : speed->doubleValue();
}
